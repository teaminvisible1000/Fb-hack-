...
logo =f"""
  _______                     _            _     _ _     _       
 |__   __|                   (_)          (_)   (_) |   | |      
    | | ___  __ _ _ __ ___    _ _ ____   ___ ___ _| |__ | | ___  
    | |/ _ \/ _` | '_ ` _ \  | | '_ \ \ / / / __| | '_ \| |/ _ \ 
    | |  __/ (_| | | | | | | | | | | \ V /| \__ \ | |_) | |  __/ 
    |_|\___|\__,_|_| |_| |_| |_|_| |_|\_/ |_|___/_|_.__/|_|\___| 
                                                                 
                                                                 

{A}──────────────────────────────────────────────────
{G1}[{A}={G1}]{G1} OWNER    {A}:{G1} Antu Chowdhuwry
{G1}[{A}={G2}]{G2} FACEBOOK {A}:{G2} Hdr Antu Chowdhury\_____:*\❷/3:)\⓿
{G1}[{A}={G3}]{G3} TOOLTYPE {A}:{G3} FILE {A}&{G4} RANDOM CLONING
{G1}[{A}={G4}]{G4} STATUS   {A}:{G4} Paid Version
{A}──────────────────────────────────────────────────"""
...
def menu():   
    ...
    if select =='1':
        ...
        os.system('xdg-open https://www.facebook.com/hdrantuchowdhury48?mibextid=ZbWKwL');menu()
    elif select =='0':
...
def _bd_():
    ...
    print('')
    print(f'\r{A}──────────────────────────────────────────────────')
    print(f'{G1}[{A}={G1}]{G1} THE PROCESS HAS BEEN COMPLETED THANKS FOR USE MY TOOL')
